  ...
  return (
    <div className="w-full max-w-sm overflow-hidden rounded-lg bg-white shadow-md duration-300 hover:scale-105 hover:shadow-xl">
      ...
      <div className="space-x-4 bg-gray-100 py-4 text-center">
        <button className="inline-block rounded-md bg-green-500 px-10 py-2 font-semibold text-red-100 shadow-md duration-75 hover:bg-green-700">
          시작
        </button>
        <button className="inline-block rounded-md bg-blue-500 px-6 py-2 font-semibold text-green-100 shadow-md duration-75 hover:bg-blue-700">
          설명보기
        </button>
      </div>
    </div>
